...
public class TesteCadastro {
	...
	driver.findElement(By.id("elementosForm:nome")).sendKeys("Johnathan");
	driver.findElement(By.id("elementosForm:sobrenome")).sendKeys("Lemes");
	...
	Assert.assertTrue(driver.findElement(By.id("descNome")).getText().endsWith("Johnathan"));
	Assert.assertEquals("Sobrenome: Lemes", driver.findElement(By.id("descSobrenome")).getText());
